...
const SentryNodeAbi = [
  ...
  },
  {
    ...
    name: "getCycleActiveLicenseCount",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  },
  {
    ...
    name: "getOperatorCycleLicenseCount",
    outputs: [
      {
        internalType: "uint256",
        name: "",
    ...
    outputs: [
      {
        ...
        internalType: "struct RegistrationData",
        name: "regData",
        type: "tuple",
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract ILicenseContract",
        name: "",
        type: "address",
      },
    ],
  ...
  },
  {
    ...
    name: "operatorCycleLicenseCount",
    outputs: [
      {
        internalType: "uint256",
        name: "",
...
const SubnetAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        indexed: false,
        internalType: "struct Subnet.StakeStruct",
        name: "stake",
        type: "tuple",
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      },
      {
        ...
        internalType: "struct Subnet.LicenseInfo[]",
        name: "info",
        type: "tuple[]",
      },
      {
    ...
    inputs: [
      {
        components: [
          ...
          },
          {
            ...
            internalType: "struct Subnet.RewardClaimData[]",
            name: "claimData",
            type: "tuple[]",
          },
          {
        ...
        internalType: "struct Subnet.Claim",
        name: "claim",
        type: "tuple",
      },
    ],
  ...
  },
  {
    inputs: [
      {
        internalType: "uint256",
        name: "cycleNumLicences",
        type: "uint256",
      },
    ],
    name: "getMinSignerCount",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: "address",
        name: "_sentryContract",
        type: "address",
      },
      {
        internalType: "address",
        name: "_validatorNodeContract",
        type: "address",
      },
    ],
    name: "initialize",
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract INodeContract",
        name: "",
        type: "address",
      },
    ],
...
const NodeLicenseAbi = [
  ...
  {
    inputs: [],
    name: "generatePromoCodeThreshold",
    outputs: [
      {
        internalType: "uint256",
        name: "",
    ...
    outputs: [
      {
        ...
        internalType: "struct NodeLicense.Tier",
        name: "",
        type: "tuple",
      },
    ],
  ...
  },
  {
    ...
    name: "setGeneratePromoCodeThreshold",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
